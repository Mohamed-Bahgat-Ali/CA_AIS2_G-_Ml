class MessageDecoder:
    ...
    def extract_core_message(self) -> str:
        ...
        """
        # Extract from position 5 to 17 (gnirtS PLIO)
        self.core_message = self.task[5:17:1]
    ...
    def reverse_first_word(self) -> str:
        ...
        # Extract first word (gnirtS) using slicing
    ...
    def replace_shifted_vowels(self) -> str:
        ...
        # Extract second word (PLIO)
        self.second_word = self.core_message[7:11]
        
        # Replace vowels: I->E, O->U
        replaced_word = self.second_word.replace('I', 'E').replace('O', 'U')
    ...
    def decode_message(self) -> str:
        ...
        Steps:
            ...
            2. Reverse first word (gnirtS -> String)
            3. Replace vowels in second word (PLIO -> PLEU)
    ...
    def display_step_by_step(self) -> None:
        ...
        core = task[5:17:1]
        print(f"Step 1: task[5:17:1] -> {core}")
        print(f"Expected: gnirtS PLIO")
        print()
        
        # Step 2: Extract first and second word
        x = task[5:11:1]   # gnirtS
        y = task[12:16:1]  # PLIO
        print(f"Step 2: x = task[5:11:1] -> {x}")
        print(f"        y = task[12:16:1] -> {y}")
        print(f"        print(x[::-1], y) -> {x[::-1]} {y}")
        print(f"Expected: String PLIO")
        print()
        
        # Step 3: Replace vowels in second word
        y_replaced = y.replace('I', 'E').replace('O', 'U')
        print(f"Step 3: Replace vowels in '{y}'")
        print(f"        I -> E, O -> U")
        print(f"        {y} -> {y_replaced}")
        print(f"Expected: PLEU")
        print()
...
if __name__ == "__main__":
    ...
    print("TESTING MESSAGE DECODER - TASK 3")
    print("=" * 60)
